<?php $__env->startSection('title', 'Publicar Post'); ?>
                ...
                <div class="card" style="padding-bottom: 30px;">
                    ...
                    <div class="card-content">
                        <div class="row">
                            ...
                            <!--End col-md-4-->
                            <div class="col-md-8">
                                <form action="<?php echo e(url('blog/blogGuardarForm')); ?>" class="form" method="post"  id="myform">
...
<?php $__env->startSection('script'); ?>
    ...
    <script src=<?php echo e(asset('js/admin/post.js')); ?> type="text/javascript"></script>
