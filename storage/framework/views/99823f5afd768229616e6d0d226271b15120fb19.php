            ...
            <div class="col-md-12">
                <div class="card" style="padding-bottom: 30px;">
                    ...
                    <div class="card-content">
                        <div class="row">
                            <div class="col-md-4">
                                 <form action="<?php echo e(url('blog/blogGuardar')); ?>" method="post" class="dropzone" id="my-awesome-dropzone" style="border: none !important; margin-top: 25px;">
                                ...
                                <div class="col-md-12">
                                    <?php $__currentLoopData = $imagenes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $imagen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="col-xs-3 col-md-6" style="margin-bottom: 10px;">
                                            <img class="asd" id="<?php echo e($imagen->id); ?>" style="cursor: pointer;width: 50px;height: 50px;" src="<?php echo e(asset($thumby)); ?>"  alt="<?php echo e($post->titulo); ?>"  data-image="<?php echo e(asset('img/products.png')); ?>" >
                                        </div>
                            ...
                            <!--End col-md-4-->
                            <div class="col-md-8">
                                <form action="<?php echo action('BlogController@update', ['id' => $post->id]); ?>" method="post" id="myform">
                                    ...
                                    <div class="form-group">
                                        <select class="form-control" id="categoria_hijo">
                                            <option value="<?php echo e($lvl_2[0]->id); ?>"><?php echo e($lvl_2[0]->descripcion); ?></option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <select name="id_categoria_post" class="form-control" id="categoria_nieto" required>
                                            <option value="<?php echo e($lvl_3[0]->id); ?>"><?php echo e($lvl_3[0]->descripcion); ?></option>
                                        </select>
                                    </div>
                                    <div class="form-group" style="padding: 0; margin: 0">
                                        <label for="" class="col-sm-2 control-label" style="font-size: 14px;">Título</label>
                                        <input type="text" name="titulo" value="<?php echo e($post->titulo); ?>" class="form-control" required autofocus>
                                    </div>
                                     <div class="col-md-12">
                                        <textarea name="descripcion"><?php echo e($post->descripcion); ?></textarea>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src=<?php echo e(asset('js/admin/editar_post.js')); ?> type="text/javascript"></script>
